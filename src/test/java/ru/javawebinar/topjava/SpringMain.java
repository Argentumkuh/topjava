...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml", "spring/spring-db.xml")) {
            ...
            service.getAll(100001).forEach(System.out::println);*/
            MealRestController controller = appCtx.getBean(MealRestController.class);
            //controller.getAll().forEach(System.out::println);
            controller.getBetween(LocalDate.of(2017, Month.NOVEMBER, 22), LocalTime.of(8, 0),
                    LocalDate.of(2017, Month.NOVEMBER, 22), LocalTime.of(10, 0))
